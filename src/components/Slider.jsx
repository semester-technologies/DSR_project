...
function Slider() {
  ...
  return (
    <>
      <div className="lg:relative bg-[#0A064066] lg:top-0 lg:w-[300px] idden xl:w-[300px] absolute lg:h-[100vh] h-[93vh] top-18 overflow-y-scroll md:w-[900px] md:overflow-y-auto w-[440px] z-10 lg:overflow-y-scroll 2xl:overflow-y-auto px-2">
        <div className="flex absolute left-0 flex-col lg:w-[300px] justify-between bg-[#fff] idden h-[100vh] lg:h-[720px] xl:h-[100vh] w-[280px]">
          <div className="h-[92vh] flex justify-between lg:h-[100vh] flex-col">
            <div className="pt-3">
              <Link
                to="/"
                onClick={goHome}
